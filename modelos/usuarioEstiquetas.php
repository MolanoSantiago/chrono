...
class usuarioEtiqueta{
    ...
    public static function mostrarUE(){
        ...
        $sql = $baseDatos->query('SELECT UE.*, eti.etiqueta  FROM usuarios_etiquetas UE, etiquetas eti  WHERE UE.idUsuario = 1 AND UE.idEtiqueta=eti.idEtiqueta ORDER BY idUsuarioEtiqueta DESC' );
    ...
    public function registrarUE($UsuarioEtiqueta){
        ...
        usuarios_etiquetas(idUsuarioEtiqueta,idUsuario,idEtiqueta)
        VALUES(:idUsuarioEtiqueta,:idUsuario,:idEtiqueta) ');
